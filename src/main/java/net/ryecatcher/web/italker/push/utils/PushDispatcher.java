...
public class PushDispatcher {
    private static final String appId = "hxPXGY2KE58Paa8tew7AU2";
    private static final String appKey = "hv6H9Rrizf5rIdZ3YgIoS8";
    private static final String masterSecret = "hkzVLAbnvpAnvw0sV4l6m9";
